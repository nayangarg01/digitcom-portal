...
OUTPUT_FILE = "km_calculated_v2.xlsx"
OUTPUT_SHEET = "A6 & MM Wave - Distances"

# Bands to keep (exact match, case-insensitive strip)
TARGET_BANDS = {"A6 I&C", "MM WAVE"}
...
def calculate_distances(api_key, input_file, output_file):
    ...
    print(f"Rows after filtering (A6 I&C + MM WAVE): {len(df_filtered)}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Calculate driving distance from each site's assigned WH (A6 I&C + MM WAVE only)."
    )
